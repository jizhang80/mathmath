...
| 7 EPIC plan | 7a `docs/epic-plan.md` drafted 2026-09-09 (EPICs 01–13 + M5 queue; Demo = EPICs 01–04); EPIC 01 brief at `docs/epics/`; **owner sign-off pending**, then 7b via `/run-epic 01` from an Opus session |
